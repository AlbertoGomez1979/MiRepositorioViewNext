...
<body>
	...
	<br>
	<div class="container">
		<h1>Detalle del Empleado</h1><br>
		<form:form class="row g-3" method="POST" action="/spring-mvc-app/actualizar/${empleado_id}">
		    <p>${empleado_id}</p>
			...
			<div class="col-12">
			    <%-- <a href="actualizar/${empleado_id}" class="btn btn-primary" >Guardar</a> --%>
