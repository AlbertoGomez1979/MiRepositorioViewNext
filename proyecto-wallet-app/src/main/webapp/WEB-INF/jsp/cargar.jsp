...
<html lang="es">
    ...
    <body>
            <div class="cargar">
                ...
                <form class="rog g-3">
                    <div class="col-md-4">
                        <label for="validationDefault01" class="form-label">Indique la wallet</label>
                    ...
                    <div class="col-md-4">
                        <label for="validationDefault03" class="form-label">Tarjeta bancaria</label>
                    ...
                    <div class="mb-3">                   
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Realizar</button>

                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cargar wallet</h5>
